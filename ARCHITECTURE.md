...
required by the Functions runtime (AzureWebJobsStorage) but is not used by application code
in this CS.

Forward-looking shape (filled out by CS03 — see [Persistence](#persistence) under
